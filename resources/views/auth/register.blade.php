                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="designation_id" type="text" class="form-control{{ $errors->has('designation_id') ? ' is-invalid' : '' }}" name="designation_id" value="{{ old('designation_id') }}" required autofocus>
