...
<script>
    ...
    export default {
        ...
        data() {
            return {
                form: new Form({
                    ...
                    project_managers: this.project.managers,
                    project_stakeholders: this.project.stakeholders,
        ...
        methods: {
            onSubmit() {
                this.form.post('/project/update/'+this.project.id)
        ...
        watch: {
            status() {
                this.form.project_managers = this.project.managers;
                this.form.project_stakeholders = this.project.stakeholders;
                this.form.project_status = this.project.status;
                this.form.program = this.project.program;
            }
        },
        mounted() {
        }
