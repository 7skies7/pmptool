        ...
        <div class="card card-default shadow-sm">
            ...
            <div class="card-body">
                <form @submit.prevent="onSubmit" @keydown="form.errors.clear()">
                    ...
                    <div class="form-group row">
                        <label for="program_start_date" class="col-md-4 col-form-label text-md-right">Project Start Date</label>
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="form-group row">
                        <label for="program_end_date" class="col-md-4 col-form-label text-md-right">Project End Date</label>
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="form-group row">
                        <label for="program_desc" class="col-md-4 col-form-label text-md-right">Select Manager</label>
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="form-group row">
                        <label for="program_desc" class="col-md-4 col-form-label text-md-right">Stakeholders</label>
...
<!--                             <button type="submit" class="btn btn-primary" :disabled="form.errors.any()">
                            ...
                            <router-link to="/project/update" class="btn btn-primary no-link">Save</router-link>
